...
const FALLBACK_PAYOUTS: PayoutTableRow[] = [
  {
    id: 1,
    raw_id: 1,
    payout_code: 'PO-1',
    user_id: 101,
    trader_name: 'Alexander Sterling',
    email: 'alex.sterling@quantfunds.io',
    amount_requested: 4250.00,
    trader_amount: 3612.50,
    firm_amount: 637.50,
    profit_split_pct: 85,
    payment_method: 'Crypto TRC20',
    payment_address: 'TQ5xWzV58Z1mQ7rP9fK2jN8xL4yB6vC3dA',
    status: 'requested',
    requested_at: '2026-08-13T18:40:00Z',
  },
  {
    id: 2,
    raw_id: 2,
    payout_code: 'PO-2',
    user_id: 102,
    trader_name: 'Sarah Chen',
    email: 'sarah.chen@fxalphagroup.com',
    amount_requested: 8900.00,
    trader_amount: 7120.00,
    firm_amount: 1780.00,
    profit_split_pct: 80,
    payment_method: 'Bank Wire',
    payment_address: 'IBAN: GB29 NWBK 6016 1331 9268 19 • Swift: NWBKGB2L',
    status: 'under_review',
    requested_at: '2026-08-13T14:15:00Z',
  },
  {
    id: 3,
    raw_id: 3,
    payout_code: 'PO-3',
    user_id: 103,
    trader_name: 'Marcus Vance',
    email: 'marcus.vance@institutionaltrade.com',
    amount_requested: 540.00,
    trader_amount: 432.00,
    firm_amount: 108.00,
    profit_split_pct: 80,
    payment_method: 'Crypto TRC20',
    payment_address: 'TQ5xWzV58Z1mQ7rP9fK2jN8xL4yB6vC3dA',
    status: 'requested',
    requested_at: '2026-08-12T16:20:00Z',
  },
  {
    id: 4,
    raw_id: 4,
    payout_code: 'PO-4',
    user_id: 104,
    trader_name: 'Elena Rostova',
    email: 'elena.rostova@marketmakercrypto.io',
    amount_requested: 5600.00,
    trader_amount: 4480.00,
    firm_amount: 1120.00,
    profit_split_pct: 80,
    payment_method: 'Crypto BEP20',
    payment_address: '0x89F2A71d4C8B08a54A94bC80521e6490FDbCe2B1',
    status: 'approved',
    tx_reference: '0x3a9b...7f12',
    requested_at: '2026-08-11T09:10:00Z',
    processed_at: '2026-08-11T11:45:00Z',
  },
  {
    id: 5,
    raw_id: 5,
    payout_code: 'PO-5',
    user_id: 105,
    trader_name: 'David Kim',
    email: 'david.kim@seoulalpha.kr',
    amount_requested: 2100.00,
    trader_amount: 1680.00,
    firm_amount: 420.00,
    profit_split_pct: 80,
    payment_method: 'Wise Transfer',
    payment_address: 'wise: david.kim@seoulalpha.kr',
    status: 'rejected',
    admin_note: 'Daily drawdown rule breached during trading cycle prior to payout audit.',
    requested_at: '2026-08-10T11:00:00Z',
  },
  {
    id: 6,
    raw_id: 6,
    payout_code: 'PO-6',
    user_id: 106,
    trader_name: 'Liam Gallagher',
    email: 'liam.gallagher@manchesterprop.co.uk',
    amount_requested: 12400.00,
    trader_amount: 9920.00,
    firm_amount: 2480.00,
    profit_split_pct: 80,
    payment_method: 'Bank Wire',
    payment_address: 'IBAN: GB99 BARC 2000 0012 3456 78',
    status: 'approved',
    tx_reference: 'WIRE-992140',
    requested_at: '2026-08-08T15:30:00Z',
    processed_at: '2026-08-08T17:10:00Z',
  }
]
